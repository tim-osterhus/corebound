...
class IronLanternDescentArcadeReleaseTests(unittest.TestCase):
    def test_manifest_lists_truthful_cave_readability_release_and_local_thumbnail(self) -> None:
        ...
        self.assertIn("pause/help controls", game["versions"][0]["summary"])
        self.assertIn("reduced-motion handling", game["versions"][0]["summary"])
        self.assertIn("restart confirmation", game["versions"][0]["summary"])
    ...
    def test_game_entrypoint_uses_title_card_and_asset_manifest(self) -> None:
        ...
        self.assertIn("pause-help-overlay", html)
        self.assertIn("reduced-motion-toggle", html)
        self.assertIn("restart-confirmation", html)
